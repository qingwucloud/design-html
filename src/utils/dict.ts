...
export enum DICT_TYPE {
  ...
  // ========== 设计师 作品集 新增模块 ==========
  DESIGNER_GRADE_TYPE = "designer_grade_type", // 设计师等级
  DESIGNER_STYLE_TYPE = "designer_style_type", // 设计师风格
  PORTFOLIO_HOUSE_TYPE = "portfolio_house_type", // 作品集户型类型
  PORTFOLIO_TAG_TYPE = "portfolio_tag_type", // 作品集标签类型
