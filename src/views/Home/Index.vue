    ...
    <el-row :gutter="16" class="row">
      ...
      <el-col :md="6" :sm="12" :xs="24" :loading="loading">
        <ComparisonCard
          tag="今日"
          title="预约设计师"
          :value="userComparison?.value?.appointmentCount || 0"
          :reference="userComparison?.reference?.appointmentCount || 0"
        />
      </el-col>
      <el-col :md="6" :sm="12" :xs="24" :loading="loading">
        <ComparisonCard
          tag="今日"
          title="新增合同"
          :value="userComparison?.value?.contractCount || 0"
          :reference="userComparison?.reference?.contractCount || 0"
        />
      </el-col>
    </el-row>
    <el-row :gutter="16" class="row">
...
import { getuserCountComparison } from '@/api/mall/statistics/trade'
...
import BusinessCard from '@/views/Home/components/BusinessCard.vue'
...
const userComparison = ref<any>() // 会员对照数据
